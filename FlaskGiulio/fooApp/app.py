...
app.config['MONGO_URI'] =  'mongodb+srv://flaskgiulio:yywQaaNk7nfdr9Pt@cluster0.wat6d.mongodb.net/foodb?retryWrites=true&w=majority'
app.config['SECRET_KEY'] = 'yywQaaNk7nfdr9Pt' 
